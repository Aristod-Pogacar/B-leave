...
exports.HolidayModule = HolidayModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([holiday_entity_1.Holiday, history_entity_1.History])],
        controllers: [holiday_controller_1.HolidayController],
        providers: [holiday_service_1.HolidayService, history_service_1.HistoryService],
        exports: [holiday_service_1.HolidayService, history_service_1.HistoryService]
    })
], HolidayModule);
